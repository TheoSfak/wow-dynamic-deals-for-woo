...
<div class="wdd-page-header wdd-flex-between">
	<div>
		<h2>🎁 <?php esc_html_e( 'Free Gift Rules', 'wow-dynamic-deals-for-woo' ); ?></h2>
		<p><?php esc_html_e( 'Delight customers with automatic free gifts based on purchase conditions', 'wow-dynamic-deals-for-woo' ); ?></p>
	</div>
	<button class="wdd-btn wdd-btn-primary wdd-add-rule" data-type="gift">
		<span style="font-size: 18px;">➕</span> <?php esc_html_e( 'Add Gift Rule', 'wow-dynamic-deals-for-woo' ); ?>
	</button>
</div>
...
<div class="wdd-rules-list">
	<?php if ( empty( $rules ) ) : ?>
		<div class="wdd-empty-state wdd-fade-in">
			...
			<h3><?php esc_html_e( 'No Gift Rules Yet', 'wow-dynamic-deals-for-woo' ); ?></h3>
			<p><?php esc_html_e( 'Surprise your customers with free gifts to increase satisfaction and loyalty!', 'wow-dynamic-deals-for-woo' ); ?></p>
			<button class="wdd-btn wdd-btn-primary wdd-btn-lg wdd-add-rule" data-type="gift">
				<span style="font-size: 20px;">➕</span> <?php esc_html_e( 'Create Your First Gift Rule', 'wow-dynamic-deals-for-woo' ); ?>
			</button>
		</div>
	<?php else : ?>
			...
			<table class="wdd-table">
				<thead>
					<tr>
						...
						<th><?php esc_html_e( 'Trigger', 'wow-dynamic-deals-for-woo' ); ?></th>
						<th><?php esc_html_e( 'Max Gifts', 'wow-dynamic-deals-for-woo' ); ?></th>
						...
						<tr>
							...
							<td>
								<strong style="color: #667eea;">
									<?php echo esc_html( $rule->max_gifts_per_order ? $rule->max_gifts_per_order : __( '∞ Unlimited', 'wow-dynamic-deals-for-woo' ) ); ?>
								</strong>
							</td>
							<td>
