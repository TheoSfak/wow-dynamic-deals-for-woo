...
<div id="wdd-cart-modal" class="wdd-modal" style="display:none;">
	...
	<div class="wdd-modal-content">
		<div class="wdd-modal-header">
			<h2 id="wdd-cart-modal-title"><?php esc_html_e( 'Add Cart Discount', 'wow-dynamic-deals-for-woo' ); ?></h2>
		...
		<form id="wdd-cart-form">
			...
			<div class="wdd-modal-body">
				...
				<div class="wdd-form-section">
					<h3><?php esc_html_e( 'Discount Settings', 'wow-dynamic-deals-for-woo' ); ?></h3>
					
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-discount-type">
								<?php esc_html_e( 'Discount Type', 'wow-dynamic-deals-for-woo' ); ?>
								<span class="required">*</span>
							</label>
						...
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-discount-value">
								<?php esc_html_e( 'Discount Value', 'wow-dynamic-deals-for-woo' ); ?>
								<span class="required">*</span>
							</label>
					...
					<div class="wdd-form-group">
						<label>
							...
							<?php esc_html_e( 'Apply free shipping when this rule is active', 'wow-dynamic-deals-for-woo' ); ?>
						</label>
					</div>
				</div>

				<div class="wdd-form-section">
					<h3><?php esc_html_e( 'Cart Conditions', 'wow-dynamic-deals-for-woo' ); ?></h3>
					
					<div class="wdd-form-group">
						<label>
							<input type="checkbox" name="first_order_only" value="1">
							<?php esc_html_e( 'Apply only to first order (new customers)', 'wow-dynamic-deals-for-woo' ); ?>
						</label>
						<p class="description"><?php esc_html_e( 'Discount will only apply if customer has never placed an order before. Works for both logged-in users and guest email addresses.', 'wow-dynamic-deals-for-woo' ); ?></p>
					</div>
					
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-min-total"><?php esc_html_e( 'Min Cart Total', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="number" id="wdd-cart-min-total" name="min_cart_total" class="wdd-input-text" step="0.01" min="0" placeholder="0.00">
						</div>
						
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-max-total"><?php esc_html_e( 'Max Cart Total', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="number" id="wdd-cart-max-total" name="max_cart_total" class="wdd-input-text" step="0.01" min="0" placeholder="<?php esc_attr_e( 'Unlimited', 'wow-dynamic-deals-for-woo' ); ?>">
						</div>
					</div>
					
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-min-quantity"><?php esc_html_e( 'Min Cart Quantity', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="number" id="wdd-cart-min-quantity" name="min_cart_quantity" class="wdd-input-text" min="0" placeholder="0">
						</div>
						
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-max-quantity"><?php esc_html_e( 'Max Cart Quantity', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="number" id="wdd-cart-max-quantity" name="max_cart_quantity" class="wdd-input-text" min="0" placeholder="<?php esc_attr_e( 'Unlimited', 'wow-dynamic-deals-for-woo' ); ?>">
						</div>
					</div>
				</div>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-date-from"><?php esc_html_e( 'Start Date', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="date" id="wdd-cart-date-from" name="date_from" class="wdd-input-text">
						</div>
						
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-cart-date-to"><?php esc_html_e( 'End Date', 'wow-dynamic-deals-for-woo' ); ?></label>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-group">
						<label for="wdd-cart-user-ids"><?php esc_html_e( 'Specific Users', 'wow-dynamic-deals-for-woo' ); ?></label>
			...
			<div class="wdd-modal-footer">
				...
				<button type="submit" class="button button-primary"><?php esc_html_e( 'Save Cart Discount', 'wow-dynamic-deals-for-woo' ); ?></button>
			</div>
		</form>
	</div>
</div>
