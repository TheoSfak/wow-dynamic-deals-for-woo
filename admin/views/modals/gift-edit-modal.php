...
<div id="wdd-gift-modal" class="wdd-modal" style="display:none;">
	...
	<div class="wdd-modal-content">
		<div class="wdd-modal-header">
			<h2 id="wdd-gift-modal-title"><?php esc_html_e( 'Add Gift Rule', 'wow-dynamic-deals-for-woo' ); ?></h2>
		...
		<form id="wdd-gift-form" novalidate>
			...
			<div class="wdd-modal-body">
				...
				<div class="wdd-form-section">
					<h3><?php esc_html_e( 'Trigger Conditions', 'wow-dynamic-deals-for-woo' ); ?></h3>
					...
					<div id="wdd-main-trigger-section" style="padding: 15px; background: #f0f8ff; border: 2px solid #4a90e2; border-radius: 8px; margin-bottom: 20px;">
						<h4 style="margin: 0 0 15px 0; color: #4a90e2; font-size: 14px;">
							🎯 <?php esc_html_e( 'Main Trigger Condition', 'wow-dynamic-deals-for-woo' ); ?>
						</h4>
						
						<div class="wdd-form-group" style="margin-bottom: 15px;">
							<label for="wdd-gift-trigger-type">
								<?php esc_html_e( 'Trigger Type', 'wow-dynamic-deals-for-woo' ); ?>
								<span class="required">*</span>
							</label>
							<select id="wdd-gift-trigger-type" name="trigger_type" class="wdd-select" required>
								<option value=""><?php esc_html_e( 'Select trigger...', 'wow-dynamic-deals-for-woo' ); ?></option>
								<option value="product"><?php esc_html_e( 'Specific Products in Cart', 'wow-dynamic-deals-for-woo' ); ?></option>
								<option value="category"><?php esc_html_e( 'Products from Categories in Cart', 'wow-dynamic-deals-for-woo' ); ?></option>
								<option value="cart_total"><?php esc_html_e( 'Minimum Cart Total', 'wow-dynamic-deals-for-woo' ); ?></option>
								<option value="cart_quantity"><?php esc_html_e( 'Minimum Cart Quantity', 'wow-dynamic-deals-for-woo' ); ?></option>
							</select>
						</div>
						
						<!-- Main Trigger: Product -->
						<div class="wdd-form-group wdd-trigger-field" data-trigger="product" style="display:none;">
							<label for="wdd-gift-trigger-products"><?php esc_html_e( 'Trigger Products', 'wow-dynamic-deals-for-woo' ); ?></label>
							...
							<p class="description"><?php esc_html_e( 'Gift will be added when any of these products are in cart', 'wow-dynamic-deals-for-woo' ); ?></p>
						</div>
						
						<!-- Main Trigger: Category -->
						<div class="wdd-form-group wdd-trigger-field" data-trigger="category" style="display:none;">
							<label for="wdd-gift-trigger-categories"><?php esc_html_e( 'Trigger Categories', 'wow-dynamic-deals-for-woo' ); ?></label>
							...
							<p class="description"><?php esc_html_e( 'Gift will be added when products from these categories are in cart', 'wow-dynamic-deals-for-woo' ); ?></p>
						</div>
						
						<!-- Main Trigger: Cart Total -->
						<div class="wdd-form-group wdd-trigger-field" data-trigger="cart_total" style="display:none;">
							<label for="wdd-gift-trigger-cart-total"><?php esc_html_e( 'Minimum Cart Total', 'wow-dynamic-deals-for-woo' ); ?></label>
							...
							<p class="description"><?php esc_html_e( 'Gift will be added when cart total reaches this amount', 'wow-dynamic-deals-for-woo' ); ?></p>
						</div>
						
						<!-- Main Trigger: Cart Quantity -->
						<div class="wdd-form-group wdd-trigger-field" data-trigger="cart_quantity" style="display:none;">
							<label for="wdd-gift-trigger-cart-quantity"><?php esc_html_e( 'Minimum Cart Quantity', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="number" id="wdd-gift-trigger-cart-quantity" name="trigger_quantity" class="wdd-input-text" min="1" placeholder="5">
							<p class="description"><?php esc_html_e( 'Gift will be added when cart has this many items', 'wow-dynamic-deals-for-woo' ); ?></p>
						</div>
					</div>
					...
					<div class="wdd-form-group" style="margin-bottom: 20px;">
						<button type="button" class="wdd-btn wdd-btn-secondary" id="wdd-add-trigger" style="width: 100%;">
							<span style="font-size: 18px;">+</span> <?php esc_html_e( 'Add Additional Trigger Condition', 'wow-dynamic-deals-for-woo' ); ?>
						</button>
						<p class="description" style="margin-top: 8px; text-align: center;">
							<em><?php esc_html_e( 'Add multiple conditions and choose AND (all must match) or OR (any can match)', 'wow-dynamic-deals-for-woo' ); ?></em>
						</p>
					</div>
					...
					<div id="wdd-trigger-logic-group" style="display: none; margin-bottom: 20px; padding: 10px; background: #fff9e6; border: 2px solid #f39c12; border-radius: 8px;">
						<label style="font-weight: bold; color: #f39c12;"><?php esc_html_e( '⚡ Trigger Logic', 'wow-dynamic-deals-for-woo' ); ?></label>
				...
				<div class="wdd-form-section">
					<h3><?php esc_html_e( 'Gift Products', 'wow-dynamic-deals-for-woo' ); ?></h3>
					
					<div class="wdd-form-group">
						<label for="wdd-gift-products">
							<?php esc_html_e( 'Products to Give as Gifts', 'wow-dynamic-deals-for-woo' ); ?>
							<span class="required">*</span>
						</label>
						...
						<p class="description"><?php esc_html_e( 'These products will be added to cart automatically at $0 price', 'wow-dynamic-deals-for-woo' ); ?></p>
					</div>
					
					<div class="wdd-form-group">
						<label for="wdd-gift-max-gifts"><?php esc_html_e( 'Maximum Gifts per Order', 'wow-dynamic-deals-for-woo' ); ?></label>
					<input type="number" id="wdd-gift-max-gifts" name="max_gifts_per_order" class="wdd-input-text" min="1" value="1" placeholder="1">
					<p class="description">
						<?php esc_html_e( 'Limit the total number of gift items per order. For example: Set to 1 to give only one free gift even if customer qualifies multiple times. Set to 2 to allow maximum 2 free gifts per order. Leave at 1 for standard promotions.', 'wow-dynamic-deals-for-woo' ); ?>
					</p>
					</div>
				</div>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-gift-date-from"><?php esc_html_e( 'Start Date', 'wow-dynamic-deals-for-woo' ); ?></label>
							<input type="date" id="wdd-gift-date-from" name="date_from" class="wdd-input-text">
						</div>
						
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-gift-date-to"><?php esc_html_e( 'End Date', 'wow-dynamic-deals-for-woo' ); ?></label>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-group">
						<label for="wdd-gift-user-ids"><?php esc_html_e( 'Specific Users', 'wow-dynamic-deals-for-woo' ); ?></label>
			...
			<div class="wdd-modal-footer">
				...
				<button type="submit" class="button button-primary"><?php esc_html_e( 'Save Gift Rule', 'wow-dynamic-deals-for-woo' ); ?></button>
			</div>
		</form>
	</div>
</div>
