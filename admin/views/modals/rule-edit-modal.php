...
<div id="wdd-rule-modal" class="wdd-modal" style="display:none;">
	...
	<div class="wdd-modal-content">
		<div class="wdd-modal-header">
			<h2 id="wdd-modal-title"><?php esc_html_e( 'Add Price Rule', 'woo-dynamic-deals' ); ?></h2>
		...
		<form id="wdd-rule-form">
			...
			<div class="wdd-modal-body">
				<div class="wdd-form-row">
					...
					<div class="wdd-form-group wdd-col-4">
						<label for="wdd-rule-priority">
							...
							<span class="wdd-tooltip" title="<?php esc_attr_e( 'Higher numbers have higher priority', 'woo-dynamic-deals' ); ?>">?</span>
						</label>
				...
				<div class="wdd-form-row">
					<div class="wdd-form-group wdd-col-6">
						<label for="wdd-adjustment-type">
							<?php esc_html_e( 'Adjustment Type', 'woo-dynamic-deals' ); ?>
							<span class="required">*</span>
						</label>
						<select id="wdd-adjustment-type" name="adjustment_type" class="wdd-select" required>
							...
							<option value="percentage_discount"><?php esc_html_e( 'Percentage Discount', 'woo-dynamic-deals' ); ?></option>
							<option value="fixed_discount"><?php esc_html_e( 'Fixed Discount', 'woo-dynamic-deals' ); ?></option>
							<option value="percentage_increase"><?php esc_html_e( 'Percentage Increase', 'woo-dynamic-deals' ); ?></option>
							<option value="fixed_increase"><?php esc_html_e( 'Fixed Increase', 'woo-dynamic-deals' ); ?></option>
						</select>
					</div>
					
					<div class="wdd-form-group wdd-col-6">
						<label for="wdd-adjustment-value">
							<?php esc_html_e( 'Value', 'woo-dynamic-deals' ); ?>
							<span class="required">*</span>
						</label>
				...
				<div class="wdd-form-row">
					<div class="wdd-form-group wdd-col-12">
						<label><?php esc_html_e( 'Apply To', 'woo-dynamic-deals' ); ?></label>
						<div class="wdd-radio-group">
							<label>
								<input type="radio" name="apply_to" value="regular_price" checked>
								<?php esc_html_e( 'Regular Price', 'woo-dynamic-deals' ); ?>
							</label>
							<label>
								<input type="radio" name="apply_to" value="sale_price">
								<?php esc_html_e( 'Sale Price', 'woo-dynamic-deals' ); ?>
							</label>
							<label>
								<input type="radio" name="apply_to" value="both">
								<?php esc_html_e( 'Both', 'woo-dynamic-deals' ); ?>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-group">
						<label for="wdd-product-ids"><?php esc_html_e( 'Specific Products', 'woo-dynamic-deals' ); ?></label>
					...
					<div class="wdd-form-group">
						<label for="wdd-category-ids"><?php esc_html_e( 'Product Categories', 'woo-dynamic-deals' ); ?></label>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-date-from"><?php esc_html_e( 'Start Date', 'woo-dynamic-deals' ); ?></label>
							<input type="date" id="wdd-date-from" name="date_from" class="wdd-input-text">
						</div>
						
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-date-to"><?php esc_html_e( 'End Date', 'woo-dynamic-deals' ); ?></label>
					...
					<div class="wdd-form-row">
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-time-from"><?php esc_html_e( 'Start Time', 'woo-dynamic-deals' ); ?></label>
							<input type="time" id="wdd-time-from" name="time_from" class="wdd-input-text">
						</div>
						
						<div class="wdd-form-group wdd-col-6">
							<label for="wdd-time-to"><?php esc_html_e( 'End Time', 'woo-dynamic-deals' ); ?></label>
					...
					<div class="wdd-form-group">
						...
						<p class="description"><?php esc_html_e( 'Leave unchecked for all days', 'woo-dynamic-deals' ); ?></p>
					</div>
				</div>
				...
				<div class="wdd-form-section">
					...
					<div class="wdd-form-group">
						...
						<p class="description"><?php esc_html_e( 'Leave unchecked for all users', 'woo-dynamic-deals' ); ?></p>
					</div>
					
					<div class="wdd-form-group">
						<label for="wdd-user-ids"><?php esc_html_e( 'Specific Users', 'woo-dynamic-deals' ); ?></label>
			...
			<div class="wdd-modal-footer">
				...
				<button type="submit" class="button button-primary"><?php esc_html_e( 'Save Rule', 'woo-dynamic-deals' ); ?></button>
			</div>
		</form>
	</div>
</div>
